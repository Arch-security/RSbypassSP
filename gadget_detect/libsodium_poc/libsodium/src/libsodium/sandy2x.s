# 1 "crypto_scalarmult/curve25519/sandy2x/sandy2x.S"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 411 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "crypto_scalarmult/curve25519/sandy2x/sandy2x.S" 2





# 1 "crypto_scalarmult/curve25519/sandy2x/consts.S" 1
...
# 1 "crypto_scalarmult/curve25519/sandy2x/consts_namespace.h" 1
# 8 "crypto_scalarmult/curve25519/sandy2x/consts.S" 2
.data
.p2align 4
crypto_scalarmult_curve25519_sandy2x_v0_0: .quad 0, 0
crypto_scalarmult_curve25519_sandy2x_v1_0: .quad 1, 0
crypto_scalarmult_curve25519_sandy2x_v2_1: .quad 2, 1
crypto_scalarmult_curve25519_sandy2x_v9_0: .quad 9, 0
crypto_scalarmult_curve25519_sandy2x_v9_9: .quad 9, 9
crypto_scalarmult_curve25519_sandy2x_v19_19: .quad 19, 19
crypto_scalarmult_curve25519_sandy2x_v38_1: .quad 38, 1
crypto_scalarmult_curve25519_sandy2x_v38_38: .quad 38, 38
crypto_scalarmult_curve25519_sandy2x_v121666_121666: .quad 121666, 121666
crypto_scalarmult_curve25519_sandy2x_m25: .quad 33554431, 33554431
crypto_scalarmult_curve25519_sandy2x_m26: .quad 67108863, 67108863
crypto_scalarmult_curve25519_sandy2x_subc0: .quad 0x07FFFFDA, 0x03FFFFFE
crypto_scalarmult_curve25519_sandy2x_subc2: .quad 0x07FFFFFE, 0x03FFFFFE
crypto_scalarmult_curve25519_sandy2x_REDMASK51: .quad 0x0007FFFFFFFFFFFF
# 7 "crypto_scalarmult/curve25519/sandy2x/sandy2x.S" 2
# 1 "crypto_scalarmult/curve25519/sandy2x/fe51_mul.S" 1





# 1 "./include/sodium/private/asm_cet.h" 1




# 1 "/home/leizhenyuu/opt/Anonymous_Repo/llvm-project/build/lib/clang/21/include/cet.h" 1 3
# 6 "./include/sodium/private/asm_cet.h" 2
# 7 "crypto_scalarmult/curve25519/sandy2x/fe51_mul.S" 2
# 1 "crypto_scalarmult/curve25519/sandy2x/fe51_namespace.h" 1
# 8 "crypto_scalarmult/curve25519/sandy2x/fe51_mul.S" 2

.text
.p2align 5

.hidden crypto_scalarmult_curve25519_sandy2x_fe51_mul
.hidden _crypto_scalarmult_curve25519_sandy2x_fe51_mul

.globl crypto_scalarmult_curve25519_sandy2x_fe51_mul
.globl _crypto_scalarmult_curve25519_sandy2x_fe51_mul

.type crypto_scalarmult_curve25519_sandy2x_fe51_mul, @function
.type _crypto_scalarmult_curve25519_sandy2x_fe51_mul, @function

crypto_scalarmult_curve25519_sandy2x_fe51_mul:
_crypto_scalarmult_curve25519_sandy2x_fe51_mul:
...
add %rax,%r14
adc %rdx,%r15
movq crypto_scalarmult_curve25519_sandy2x_REDMASK51(%rip),%rsi
shld $13,%r8,%r9
and %rsi,%r8
shld $13,%r10,%r11
and %rsi,%r10
...
mov %rsi,%rdx
ret
# 8 "crypto_scalarmult/curve25519/sandy2x/sandy2x.S" 2
# 1 "crypto_scalarmult/curve25519/sandy2x/fe51_nsquare.S" 1
# 10 "crypto_scalarmult/curve25519/sandy2x/fe51_nsquare.S"
.p2align 5


.hidden crypto_scalarmult_curve25519_sandy2x_fe51_nsquare
.hidden _crypto_scalarmult_curve25519_sandy2x_fe51_nsquare

.globl crypto_scalarmult_curve25519_sandy2x_fe51_nsquare
.globl _crypto_scalarmult_curve25519_sandy2x_fe51_nsquare

.type crypto_scalarmult_curve25519_sandy2x_fe51_nsquare, @function
.type _crypto_scalarmult_curve25519_sandy2x_fe51_nsquare, @function

crypto_scalarmult_curve25519_sandy2x_fe51_nsquare:
_crypto_scalarmult_curve25519_sandy2x_fe51_nsquare:
...
adc %rdx,%rbx
shld $13,%r15,%rbx
movq crypto_scalarmult_curve25519_sandy2x_REDMASK51(%rip),%rdx
and %rdx,%rcx
add %rbx,%rcx
and %rdx,%r9
and %rdx,%r11
...
add %r11,%rsp
ret
# 9 "crypto_scalarmult/curve25519/sandy2x/sandy2x.S" 2
# 1 "crypto_scalarmult/curve25519/sandy2x/fe51_pack.S" 1
# 10 "crypto_scalarmult/curve25519/sandy2x/fe51_pack.S"
.p2align 5


.hidden crypto_scalarmult_curve25519_sandy2x_fe51_pack
.hidden _crypto_scalarmult_curve25519_sandy2x_fe51_pack

.globl crypto_scalarmult_curve25519_sandy2x_fe51_pack
.globl _crypto_scalarmult_curve25519_sandy2x_fe51_pack

.type crypto_scalarmult_curve25519_sandy2x_fe51_pack, @function
.type _crypto_scalarmult_curve25519_sandy2x_fe51_pack, @function

crypto_scalarmult_curve25519_sandy2x_fe51_pack:
_crypto_scalarmult_curve25519_sandy2x_fe51_pack:
...
movq 24(%rsi),%r9
movq 32(%rsi),%rsi
movq crypto_scalarmult_curve25519_sandy2x_REDMASK51(%rip),%rax
lea -18(%rax),%r10
mov $3,%r11
...
add %r11,%rsp
ret
# 10 "crypto_scalarmult/curve25519/sandy2x/sandy2x.S" 2
# 1 "crypto_scalarmult/curve25519/sandy2x/ladder.S" 1



# 1 "crypto_scalarmult/curve25519/sandy2x/ladder_namespace.h" 1
# 5 "crypto_scalarmult/curve25519/sandy2x/ladder.S" 2

.p2align 5


.hidden crypto_scalarmult_curve25519_sandy2x_ladder
.hidden _crypto_scalarmult_curve25519_sandy2x_ladder

.globl crypto_scalarmult_curve25519_sandy2x_ladder
.globl _crypto_scalarmult_curve25519_sandy2x_ladder

.type crypto_scalarmult_curve25519_sandy2x_ladder, @function
.type _crypto_scalarmult_curve25519_sandy2x_ladder, @function

crypto_scalarmult_curve25519_sandy2x_ladder:
_crypto_scalarmult_curve25519_sandy2x_ladder:
...
movq %r13,1840(%rsp)
movq %r14,1848(%rsp)
vmovdqa crypto_scalarmult_curve25519_sandy2x_v0_0(%rip),%xmm0
vmovdqa crypto_scalarmult_curve25519_sandy2x_v1_0(%rip),%xmm1
vmovdqu 0(%rdi),%xmm2
vmovdqa %xmm2,0(%rsp)
vmovdqu 16(%rdi),%xmm2
vmovdqa %xmm2,16(%rsp)
...
vpmuludq crypto_scalarmult_curve25519_sandy2x_v19_19(%rip),%xmm10,%xmm10
...
vmovdqu 8(%rdi),%xmm10
vpmuludq crypto_scalarmult_curve25519_sandy2x_v2_1(%rip),%xmm10,%xmm10
...
vpmuludq crypto_scalarmult_curve25519_sandy2x_v38_1(%rip),%xmm10,%xmm10
...
vpaddq crypto_scalarmult_curve25519_sandy2x_subc0(%rip),%xmm11,%xmm10
...
vpaddq crypto_scalarmult_curve25519_sandy2x_subc0(%rip),%xmm0,%xmm0
...
vpaddq crypto_scalarmult_curve25519_sandy2x_subc2(%rip),%xmm2,%xmm2
...
vpaddq crypto_scalarmult_curve25519_sandy2x_subc2(%rip),%xmm4,%xmm4
...
vpaddq crypto_scalarmult_curve25519_sandy2x_subc2(%rip),%xmm6,%xmm6
...
vpmuludq crypto_scalarmult_curve25519_sandy2x_v19_19(%rip),%xmm5,%xmm5
...
vpmuludq crypto_scalarmult_curve25519_sandy2x_v19_19(%rip),%xmm3,%xmm3
vmovdqa %xmm3,608(%rsp)
vpaddq %xmm9,%xmm8,%xmm3
vpaddq crypto_scalarmult_curve25519_sandy2x_subc2(%rip),%xmm8,%xmm8
...
vpmuludq crypto_scalarmult_curve25519_sandy2x_v19_19(%rip),%xmm7,%xmm7
...
vpmuludq crypto_scalarmult_curve25519_sandy2x_v19_19(%rip),%xmm12,%xmm12
vpmuludq %xmm9,%xmm12,%xmm3
vmovdqa %xmm9,704(%rsp)
vpaddq %xmm3,%xmm11,%xmm11
vmovdqa 0(%rsp),%xmm3
vmovdqa 16(%rsp),%xmm9
vpaddq crypto_scalarmult_curve25519_sandy2x_subc2(%rip),%xmm3,%xmm10
...
vpmuludq crypto_scalarmult_curve25519_sandy2x_v19_19(%rip),%xmm9,%xmm9
...
vpsrlq $25,%xmm4,%xmm3
vpaddq %xmm3,%xmm6,%xmm6
vpand crypto_scalarmult_curve25519_sandy2x_m25(%rip),%xmm4,%xmm4
vpsrlq $26,%xmm11,%xmm3
vpaddq %xmm3,%xmm13,%xmm13
vpand crypto_scalarmult_curve25519_sandy2x_m26(%rip),%xmm11,%xmm11
vpsrlq $26,%xmm6,%xmm3
vpaddq %xmm3,%xmm5,%xmm5
vpand crypto_scalarmult_curve25519_sandy2x_m26(%rip),%xmm6,%xmm6
vpsrlq $25,%xmm13,%xmm3
vpaddq %xmm3,%xmm0,%xmm0
vpand crypto_scalarmult_curve25519_sandy2x_m25(%rip),%xmm13,%xmm13
vpsrlq $25,%xmm5,%xmm3
vpaddq %xmm3,%xmm8,%xmm8
vpand crypto_scalarmult_curve25519_sandy2x_m25(%rip),%xmm5,%xmm5
vpsrlq $26,%xmm0,%xmm3
vpaddq %xmm3,%xmm2,%xmm2
vpand crypto_scalarmult_curve25519_sandy2x_m26(%rip),%xmm0,%xmm0
vpsrlq $26,%xmm8,%xmm3
vpaddq %xmm3,%xmm7,%xmm7
vpand crypto_scalarmult_curve25519_sandy2x_m26(%rip),%xmm8,%xmm8
vpsrlq $25,%xmm2,%xmm3
vpaddq %xmm3,%xmm1,%xmm1
vpand crypto_scalarmult_curve25519_sandy2x_m25(%rip),%xmm2,%xmm2
vpsrlq $25,%xmm7,%xmm3
vpsllq $4,%xmm3,%xmm9
vpaddq %xmm3,%xmm11,%xmm11
vpsllq $1,%xmm3,%xmm3
...
vpand crypto_scalarmult_curve25519_sandy2x_m25(%rip),%xmm7,%xmm7
vpsrlq $26,%xmm1,%xmm3
vpaddq %xmm3,%xmm4,%xmm4
vpand crypto_scalarmult_curve25519_sandy2x_m26(%rip),%xmm1,%xmm1
vpsrlq $26,%xmm11,%xmm3
vpaddq %xmm3,%xmm13,%xmm13
vpand crypto_scalarmult_curve25519_sandy2x_m26(%rip),%xmm11,%xmm11
vpsrlq $25,%xmm4,%xmm3
...
vpaddq crypto_scalarmult_curve25519_sandy2x_subc0(%rip),%xmm9,%xmm10
...
vpaddq crypto_scalarmult_curve25519_sandy2x_subc2(%rip),%xmm0,%xmm2
...
vpaddq crypto_scalarmult_curve25519_sandy2x_subc2(%rip),%xmm1,%xmm4
...
vpaddq %xmm1,%xmm1,%xmm1
vmovdqa %xmm1,16(%rsp)
vpmuludq crypto_scalarmult_curve25519_sandy2x_v19_19(%rip),%xmm1,%xmm1
vmovdqa %xmm1,32(%rsp)
...
vpaddq crypto_scalarmult_curve25519_sandy2x_subc2(%rip),%xmm5,%xmm6
vpsubq %xmm15,%xmm6,%xmm6
vpaddq %xmm5,%xmm15,%xmm15
vpunpckhqdq %xmm15,%xmm6,%xmm5
vpunpcklqdq %xmm15,%xmm6,%xmm6
vmovdqa %xmm6,48(%rsp)
vpmuludq crypto_scalarmult_curve25519_sandy2x_v19_19(%rip),%xmm6,%xmm6
vmovdqa %xmm6,64(%rsp)
vmovdqa %xmm5,80(%rsp)
vpmuludq crypto_scalarmult_curve25519_sandy2x_v38_38(%rip),%xmm5,%xmm5
vmovdqa %xmm5,96(%rsp)
...
vpaddq crypto_scalarmult_curve25519_sandy2x_subc2(%rip),%xmm7,%xmm8
vpsubq %xmm15,%xmm8,%xmm8
vpaddq %xmm7,%xmm15,%xmm15
vpunpckhqdq %xmm15,%xmm8,%xmm7
vpunpcklqdq %xmm15,%xmm8,%xmm8
vmovdqa %xmm8,112(%rsp)
vpmuludq crypto_scalarmult_curve25519_sandy2x_v19_19(%rip),%xmm8,%xmm8
vmovdqa %xmm8,448(%rsp)
vpmuludq 112(%rsp),%xmm10,%xmm8
vpmuludq %xmm7,%xmm10,%xmm10
vpmuludq crypto_scalarmult_curve25519_sandy2x_v38_38(%rip),%xmm7,%xmm15
...
vpsrlq $26,%xmm3,%xmm2
vpaddq %xmm2,%xmm11,%xmm11
vpand crypto_scalarmult_curve25519_sandy2x_m26(%rip),%xmm3,%xmm3
vpsrlq $25,%xmm14,%xmm2
vpaddq %xmm2,%xmm5,%xmm5
vpand crypto_scalarmult_curve25519_sandy2x_m25(%rip),%xmm14,%xmm14
vpsrlq $25,%xmm11,%xmm2
vpaddq %xmm2,%xmm12,%xmm12
vpand crypto_scalarmult_curve25519_sandy2x_m25(%rip),%xmm11,%xmm11
vpsrlq $26,%xmm5,%xmm2
vpaddq %xmm2,%xmm0,%xmm0
vpand crypto_scalarmult_curve25519_sandy2x_m26(%rip),%xmm5,%xmm5
vpsrlq $26,%xmm12,%xmm2
vpaddq %xmm2,%xmm9,%xmm9
vpand crypto_scalarmult_curve25519_sandy2x_m26(%rip),%xmm12,%xmm12
vpsrlq $25,%xmm0,%xmm2
vpaddq %xmm2,%xmm8,%xmm8
vpand crypto_scalarmult_curve25519_sandy2x_m25(%rip),%xmm0,%xmm0
vpsrlq $25,%xmm9,%xmm2
vpaddq %xmm2,%xmm1,%xmm1
vpand crypto_scalarmult_curve25519_sandy2x_m25(%rip),%xmm9,%xmm9
vpsrlq $26,%xmm8,%xmm2
vpaddq %xmm2,%xmm10,%xmm10
vpand crypto_scalarmult_curve25519_sandy2x_m26(%rip),%xmm8,%xmm8
vpsrlq $26,%xmm1,%xmm2
...
vpaddq %xmm4,%xmm3,%xmm3
vpand crypto_scalarmult_curve25519_sandy2x_m25(%rip),%xmm10,%xmm10
vpsrlq $25,%xmm14,%xmm2
vpaddq %xmm2,%xmm5,%xmm5
vpand crypto_scalarmult_curve25519_sandy2x_m25(%rip),%xmm14,%xmm14
vpsrlq $26,%xmm3,%xmm2
...
vpmuludq crypto_scalarmult_curve25519_sandy2x_v38_38(%rip),%xmm14,%xmm15
...
vpsrlq $25,%xmm3,%xmm2
vpaddq %xmm2,%xmm5,%xmm5
vpand crypto_scalarmult_curve25519_sandy2x_m25(%rip),%xmm3,%xmm3
...
vpaddq %xmm2,%xmm13,%xmm13
vpand crypto_scalarmult_curve25519_sandy2x_m25(%rip),%xmm12,%xmm12
vpsrlq $25,%xmm7,%xmm2
vpaddq %xmm2,%xmm9,%xmm9
vpand crypto_scalarmult_curve25519_sandy2x_m25(%rip),%xmm7,%xmm7
vpsrlq $26,%xmm13,%xmm2
vpaddq %xmm2,%xmm0,%xmm0
vpand crypto_scalarmult_curve25519_sandy2x_m26(%rip),%xmm13,%xmm13
vpsrlq $26,%xmm9,%xmm2
vpaddq %xmm2,%xmm10,%xmm10
vpand crypto_scalarmult_curve25519_sandy2x_m26(%rip),%xmm9,%xmm9
vpsrlq $25,%xmm0,%xmm2
vpsllq $4,%xmm2,%xmm4
vpaddq %xmm2,%xmm1,%xmm1
vpsllq $1,%xmm2,%xmm2
...
vpaddq crypto_scalarmult_curve25519_sandy2x_subc0(%rip),%xmm2,%xmm3
...
vpmuludq crypto_scalarmult_curve25519_sandy2x_v121666_121666(%rip),%xmm3,%xmm3
vmovdqa 80(%rsp),%xmm1
...
vpaddq crypto_scalarmult_curve25519_sandy2x_subc2(%rip),%xmm3,%xmm5
...
vpmuludq crypto_scalarmult_curve25519_sandy2x_v121666_121666(%rip),%xmm5,%xmm5
vmovdqa 96(%rsp),%xmm3
...
vpaddq crypto_scalarmult_curve25519_sandy2x_subc2(%rip),%xmm5,%xmm7
...
vpmuludq crypto_scalarmult_curve25519_sandy2x_v121666_121666(%rip),%xmm7,%xmm7
...
vpaddq crypto_scalarmult_curve25519_sandy2x_subc2(%rip),%xmm7,%xmm9
...
vpmuludq crypto_scalarmult_curve25519_sandy2x_v121666_121666(%rip),%xmm9,%xmm9
...
vpaddq crypto_scalarmult_curve25519_sandy2x_subc2(%rip),%xmm9,%xmm10
...
vpmuludq crypto_scalarmult_curve25519_sandy2x_v121666_121666(%rip),%xmm10,%xmm10
vmovdqa 496(%rsp),%xmm0
vpunpcklqdq %xmm0,%xmm10,%xmm9
vpunpckhqdq %xmm0,%xmm10,%xmm0
vpsrlq $26,%xmm2,%xmm10
vpaddq %xmm10,%xmm1,%xmm1
vpand crypto_scalarmult_curve25519_sandy2x_m26(%rip),%xmm2,%xmm2
vpsrlq $25,%xmm5,%xmm10
vpaddq %xmm10,%xmm8,%xmm8
vpand crypto_scalarmult_curve25519_sandy2x_m25(%rip),%xmm5,%xmm5
vpsrlq $25,%xmm1,%xmm10
vpaddq %xmm10,%xmm4,%xmm4
vpand crypto_scalarmult_curve25519_sandy2x_m25(%rip),%xmm1,%xmm1
vpsrlq $26,%xmm8,%xmm10
vpaddq %xmm10,%xmm7,%xmm7
vpand crypto_scalarmult_curve25519_sandy2x_m26(%rip),%xmm8,%xmm8
vpsrlq $26,%xmm4,%xmm10
vpaddq %xmm10,%xmm3,%xmm3
vpand crypto_scalarmult_curve25519_sandy2x_m26(%rip),%xmm4,%xmm4
...
vpaddq %xmm2,%xmm14,%xmm14
vpmuludq crypto_scalarmult_curve25519_sandy2x_v19_19(%rip),%xmm15,%xmm15
...
vpmuludq crypto_scalarmult_curve25519_sandy2x_v19_19(%rip),%xmm2,%xmm2
...
vpaddq %xmm1,%xmm14,%xmm14
vpmuludq crypto_scalarmult_curve25519_sandy2x_v19_19(%rip),%xmm0,%xmm0
...
vpand crypto_scalarmult_curve25519_sandy2x_m26(%rip),%xmm7,%xmm7
vpsrlq $25,%xmm12,%xmm0
vpaddq %xmm0,%xmm13,%xmm13
vpand crypto_scalarmult_curve25519_sandy2x_m25(%rip),%xmm12,%xmm12
vpsrlq $25,%xmm8,%xmm0
vpaddq %xmm0,%xmm9,%xmm9
vpand crypto_scalarmult_curve25519_sandy2x_m25(%rip),%xmm8,%xmm8
...
add %r11,%rsp
ret
# 11 "crypto_scalarmult/curve25519/sandy2x/sandy2x.S" 2
